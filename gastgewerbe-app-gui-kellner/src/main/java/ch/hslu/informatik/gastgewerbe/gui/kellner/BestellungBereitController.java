	...
	void bestellPosAusgeliefert(ActionEvent event) {
		...
		try {
			...
			if (ausgewähltePosition != null) {
				BestellungPosition ausgeliefert = Context.getInstance().getBestellungService()
			...
			error.setContentText(
					"Die ausgewählte Position konnte nicht in den Status ausgeliefert versetzt werden. Bitte wenden Sie sich an Ihren Systemadministrator.");
			error.showAndWait();
		}
