...
import ch.hslu.informatik.gastgewerbe.gui.verwaltung.wrapper.BestellungPositionWrapper;
...
public class BestellungViewController extends TimerTask implements Initializable {

	private static Logger logger = LogManager.getLogger(BestellungViewController.class);
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		try {
							...
							if (bestellung != null) {
								...
								for (BestellungPosition p : tempListe) {
									if (p.getProdukt().getKategorie().equals(KategorieTyp.SNACK)
											...
											|| p.getProdukt().getKategorie().equals(KategorieTyp.SPEISE)) {
			...
			BestellungViewController task = new BestellungViewController();
